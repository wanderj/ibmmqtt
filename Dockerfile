...
#
# This code is an adaptation of ibm-messaging/mq-docker from Arthur Barr <arthur.barr@uk.ibm.com>


FROM ubuntu:16.04

MAINTAINER Wander Jardim <wanderjardim@gmail.com>
...
ARG MQ_PACKAGES="MQSeriesRuntime-*.rpm MQSeriesServer-*.rpm MQSeriesMsg_pt*.rpm MQSeriesJava*.rpm MQSeriesJRE*.rpm MQSeriesGSKit*.rpm MQSeriesXRService*.rpm MQSeriesSamples*.rpm MQSeriesClient*.rpm"
...
# use port 1883 for MQTT service
EXPOSE 1883
